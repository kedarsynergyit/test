...
<html lang="en">
  ...
  <body>
      ...
      MAIN CONTENT
      *********************************************************************************************************************************************************** -->
      <div class=" pull-right mr-15 mt" ><a class="btn btn-theme btn-block "  href="<?php echo base_url(); ?>index.php/portal/index">Employee Login</a></div>
	  <div id="login-page">
	  	<div class="container">
	  	
                    <form class="form-login" action="<?php echo base_url(); ?>index.php/customerportal/user_login" method="post">
		        ...
		        <div class="login-wrap">
		            ...
		            <div class="registration">
		                @Powered By<br/>
		                <a class="" href="https://www.platinait.com/">
		                   Platinait
		                </a>
		            </div>

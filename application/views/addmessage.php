     <section id="main-content">
          <section class="wrapper site-min-height">
			<div class="pull-left"><h3><i class="fa fa-chevron-circle-right"></i> Send Message</h3></div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo form_open_multipart('customerportal/insert_message','class="form-horizontal" id="form_message"');?> 
                            <div class="row">
                                ...
                                <div class="col-lg-6 ml-15">
                                		...
                                		<div class="form-group">
                                            ...
                                            <input type="hidden" name="to" id="to" value="<?php echo $accountmanager_id; ?>" />
                                            <?php echo $accountmanager_name; ?>

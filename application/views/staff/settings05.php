                                			...
                                			if(isset($contracts_files) && !empty($contracts_files)){
                                				foreach ($contracts_files as $eachFile){
                                					...
                                					<p id="user_contracts_file_<?php echo $eachFile->id; ?>">
                                						<a class="btn btn-danger btn-xs" onclick="removeExistingFile('<?php echo $eachFile->id; ?>','user_contracts');"><i class="fa fa-trash-o "></i></a>
                                						<a href="<?php echo base_url(); ?><?php echo $eachFile->file; ?>" target="_blank"><?php echo $eachFile->file_name; ?></a>
                                					</p>
                                					<?php
                                				}
                                		?>
                                			...
                                			if(isset($waivers_files) && !empty($waivers_files)){
                                				foreach ($waivers_files as $eachFile){
                                					...
                                					<p id="user_waivers_file_<?php echo $eachFile->id; ?>">
                                						<a class="btn btn-danger btn-xs" onclick="removeExistingFile('<?php echo $eachFile->id; ?>','user_waivers');"><i class="fa fa-trash-o "></i></a>
                                						<a href="<?php echo base_url(); ?><?php echo $eachFile->file; ?>" target="_blank"><?php echo $eachFile->file_name; ?></a>
                                					</p>
                                					<?php
                                				}
                                			...
                                			if(isset($insurance_files) && !empty($insurance_files)){
                                				foreach ($insurance_files as $eachFile){
                                					...
                                					<p id="user_insurance_file_<?php echo $eachFile->id; ?>">
                                						<a class="btn btn-danger btn-xs" onclick="removeExistingFile('<?php echo $eachFile->id; ?>','user_insurance');"><i class="fa fa-trash-o "></i></a>
                                						<a href="<?php echo base_url(); ?><?php echo $eachFile->file; ?>" target="_blank"><?php echo $eachFile->file_name; ?></a>
                                					</p>
                                					<?php
                                				}
                                			...
                                			if(isset($certifications_files) && !empty($certifications_files)){
                                				foreach ($certifications_files as $eachFile){
                                					...
                                					<p id="user_certifications_file_<?php echo $eachFile->id; ?>">
                                						<a class="btn btn-danger btn-xs" onclick="removeExistingFile('<?php echo $eachFile->id; ?>','user_certifications');"><i class="fa fa-trash-o "></i></a>
                                						<a href="<?php echo base_url(); ?><?php echo $eachFile->file; ?>" target="_blank"><?php echo $eachFile->file_name; ?></a>
                                					</p>
                                					<?php
                                				}
                                			...
                                			if(isset($other_files) && !empty($other_files)){
                                				foreach ($other_files as $eachFile){
                                					...
                                					<p id="user_other_file_<?php echo $eachFile->id; ?>">
                                						<a class="btn btn-danger btn-xs" onclick="removeExistingFile('<?php echo $eachFile->id; ?>','user_other');"><i class="fa fa-trash-o "></i></a>
                                						<a href="<?php echo base_url(); ?><?php echo $eachFile->file; ?>" target="_blank"><?php echo $eachFile->file_name; ?></a>
                                					</p>
                                					<?php
                                				}

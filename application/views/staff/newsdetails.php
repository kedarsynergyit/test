     <section id="main-content">
          <section class="wrapper site-min-height">
			<div class="pull-left"><h3><i class="fa fa-chevron-circle-right"></i> Blog Details</h3></div>
			<div class="pull-right"><h3><a class="btn btn-primary btn-sm btn-block" href="news">Back</a></h3></div>
           <div id="page-inner"> 
              <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="col-lg-6 ml-15">
                                      <input type='hidden' name='id' id="id" value="<?php echo $details[0]->id; ?>" />
                                        <div class="form-group">
											...
											<?php /* ?><input class="form-control right" name='news_title' id='news_title' value="<?php echo $details[0]->notification; ?>"><?php */ ?>
											<textarea class="form-control" rows="4" name="news_title" id="news_title"><?php echo $details[0]->notification; ?></textarea>

...
?>
     <section id="main-content">
          <section class="wrapper site-min-height">
           <div class="pull-left"><h3><?php /* ?><i class="fa fa-chevron-circle-right"></i><?php */ ?> Add Employee</h3></div>
			<div class="pull-right"><h3><a class="btn btn-primary btn-sm btn-block" href="employees">Back</a></h3></div>
           <div id="page-inner"> 
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo form_open_multipart('portal/insert_employee','class="form-horizontal" id="myform"');?> 
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5 ml-15">
                                    ...
                                    <!-- set the user type to internal/employee -->
                                    <input type="hidden" name="inexuser" id="inexuser" value="1" />

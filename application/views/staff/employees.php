     <section id="main-content">
          <section class="wrapper site-min-height">
          	<div class=" pull-left" ><h3><?php /* ?><i class="fa fa-angle-right"></i><?php */ ?> Employee Profiles</h3></div>
                
                <?php if($urole==1){ ?>
                	<div class=" pull-right"><h3><a href="addemployee" class="btn btn-primary btn-sm btn-block" style="color:white;">Add Employee</a></h3></div>
                <?php } ?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-users">
                                    <thead>
                                        <tr>
                                            <?php /* ?><th width="10%">Employee Id</th>
                                    ...
                                    <tbody>   <?php if(!empty($details)){ foreach($details as $row){ ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $row->phone; ?></td>
											 ...
											 <?php if($urole==1){ ?>
                                            	<td class="center"> <a href ="employeedetails?id=<?php echo $row->id; ?>" > <i class="fa fa-bars"></i></a></td>
                                            <?php } ?>
                                        </tr>
                                    <?php } } ?>
                                    </tbody>

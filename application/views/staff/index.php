      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		        ...
		        <h2 class="form-login-heading">sign in now (Employee)</h2>
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <!--<a data-toggle="modal" href="login.html#myModal"> Forgot Password?</a>-->
                                        <a data-toggle="modal" data-target="#myModalForgotPassword" href="#"> Forgot Password?</a>
		                </span>
		            </label>
		          ...
		          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalForgotPassword" class="modal fade">
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                  	<form class="form-forgotpassword" action="<?php echo base_url(); ?>index.php/portal/forgotpassword" method="post">

...
?>
     <section id="main-content">
          <section class="wrapper site-min-height">
			<div class="pull-left"><h3><?php /* ?><i class="fa fa-chevron-circle-right"></i><?php */ ?> Employee Details</h3></div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo form_open_multipart('portal/update_employee','class="form-horizontal" id="myform"');?>
                            <div class="row">

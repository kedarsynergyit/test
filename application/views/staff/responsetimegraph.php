<section id="main-content">
	<section class="wrapper site-min-height">
		...
		<div class="pull-left" ><h3><i class="fa fa-ticket"></i> Response Time Graph</h3></div>
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<!-- top filters -->
						<?php echo form_open_multipart('portal/responsetimegraph','class="form-horizontal" id="frm_sla_report"');?>
						<div class="row">
							<div class="col-lg-3">

...
?>
     <section id="main-content">
          <section class="wrapper site-min-height">
           <div class="pull-left"><h3><?php /* ?><i class="fa fa-chevron-circle-right"></i><?php */ ?> Add Tech</h3></div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo form_open_multipart('portal/insert_tech','class="form-horizontal" id="myform"');?> 
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5 ml-15">
                                    ...
                                    <!-- set the user type to external/tech -->

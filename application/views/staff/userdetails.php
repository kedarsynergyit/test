...
?>
     <section id="main-content">
          <section class="wrapper site-min-height">
			<div class="pull-left"><h3><i class="fa fa-chevron-circle-right"></i> User Details</h3></div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5 ml-15">
                                    ...
                                    <?php } ?>
                                    <div class="form-group">
                                        <button class="btn btn-sm btn-primary" name="request" id="request">Reset Password</button> 
                                        </div>

                  		...
                  		foreach ($chat_project_list as $each_chat_project){
                  			...
                  			<li class="sub-menu">
								<a href="chat_project?project_id=<?php echo $each_chat_project['project_id']; ?>" <?php if(isset($_GET['project_id']) && $_GET['project_id']==$each_chat_project['project_id']) {echo 'class="active"';} ?>>
									<span><?php echo $each_chat_project['project_name']; echo (isset($each_chat_project['num_chat_notification']) && !empty($each_chat_project['num_chat_notification']))?" (".$each_chat_project['num_chat_notification'].")":''; ?></span>
								</a>
							</li>
                  			<?php
                  		} 

...
<section id="main-content">
	...
	<div class=" pull-left">
		<h3><i class="fa fa-commenting-o"></i> Messages</h3>
	</div>
	<?php //if($urole!=1){ ?>
							...
							<?php if(!empty($details)){ foreach($details as $row){ ?>
								...
								<tr class="odd gradeX" style="font-weight:<?php echo ($row->read_unread==0)?'bold':'normal'; ?>;">
									...
									<td class="center">
										...
										<!-- reply to -->
										&nbsp;
										<a href="replyTo?id=<?php echo $row->id; ?>" title="Reply to this message..."><i class="fa fa-reply" aria-hidden="true"></i></a>
									</td>
								</tr>
								<?php } } else{
									?>
...
function markMessageAsRead(id){
	var data = "id="+id;
	var url = "<?php echo base_url().'index.php/customerportal/markMessageAsRead'; ?>";
    $.ajax({
